# This Makefile is for the Net::Cisco::MSE::REST extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/Cisco/MSE/REST.pm]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[GPL_3]
#     META_MERGE => { resources=>{ repository=>{ web=>q[https://github.com/fdurand/Net-Cisco-MSE-REST], url=>q[git://github.com/fdurand/Net-Cisco-MSE-REST], type=>q[git] } }, meta-spec=>{ version=>q[2] } }
#     NAME => q[Net::Cisco::MSE::REST]
#     PREREQ_PM => { Test::More=>q[0], LWP::UserAgent=>q[0], JSON=>q[0] }
#     TEST_REQUIRES => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Net/Cisco/MSE/REST.pm]
...
MAKE = make
FULLEXT = Net/Cisco/MSE/REST
BASEEXT = REST
PARENT_NAME = Net::Cisco::MSE
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/Cisco/MSE/REST.pm

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Net/Cisco/MSE
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Net/Cisco/MSE
...
TO_INST_PM = lib/Net/Cisco/MSE/REST.pm

PM_TO_BLIB = lib/Net/Cisco/MSE/REST.pm \
	blib/lib/Net/Cisco/MSE/REST.pm
...
DISTNAME = Net-Cisco-MSE-REST
DISTVNAME = Net-Cisco-MSE-REST-0.1
...
manifypods : pure_all  \
	lib/Net/Cisco/MSE/REST.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Net/Cisco/MSE/REST.pm $(INST_MAN3DIR)/Net::Cisco::MSE::REST.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>REST interface for Cisco MSE</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Net/Cisco/MSE/REST.pm blib/lib/Net/Cisco/MSE/REST.pm 
